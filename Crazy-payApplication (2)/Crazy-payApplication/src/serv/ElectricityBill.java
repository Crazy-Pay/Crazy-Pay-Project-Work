...
public class ElectricityBill extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String ec= "Electricity Commission";
		out.println("<html>\r\n" + 
				"    <head>\r\n" + 
				"    <style>\r\n" + 
				"      .select{\r\n" + 
				...
				"                <div class=\"container\">\r\n" + 
				"                  \r\n" + 
				"                         <br> <h2 >Electricity Bill</h2>\r\n" + 
				"        \r\n" + 
				"                          \r\n" + 
				"          \r\n" + 
				"                         <form id=\"account\" class=\"formSelect\" action=\"BillValidation\" method=\"get\">\r\n" + 
				"                              \r\n" + 
				"                            <div>\r\n" + 
				"                             <br> <input type=\"text\"class=\"fadeIn second\"  placeholder=\"Enter Consumer Number\" name=\"name\"  maxlength=\"12\"><br>\r\n" + 
				"                              <br><input type=\"text\" class=\"fadeIn third\" name=\"login\" placeholder=\"Enter Amount\"><br>\r\n" + 
				"							<br><input type=\"hidden\" name=\"id\" value=\""+mpin+"\">								"+
				"							<br><input type=\"hidden\" name=\"sname\" value=\""+ec+"\">								"+
