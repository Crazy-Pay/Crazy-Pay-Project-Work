...
/**
 * Servlet implementation class MpinValidation2
 */
@WebServlet("/MpinValidation2")
public class MpinValidation2 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String rupees2=request.getParameter("rupees2");
        ...
        System.out.println(id +"   "+mobileno+"  "+rupees2);
        ...
        out.println("<html>\r\n" + 
                ...
                "              \r\n" + 
                "                <div>"+
                "                 <form action='MpinValidator2' method='get'>"+
                "                <h4 class=\"active pt-4\" id=\"floatingSelect\"></h4><br/>\r\n" + 
                "                <br><input type=\"password\" class=\"fadeIn third\" name=\"pass\" placeholder=\"Enter M-Pin\" id=\"account\" pattern=\"[0-9]{4}\" maxlength=\"6\"><br>\r\n" + 
                "                <br> <input type='hidden' name='id' value='"+id+"'>"+
                "                <br> <input type='hidden' name='mobileNo' value='"+mobileno+"'>"+
                "                <br> <input type='hidden' name='rupees' value='"+rupees2+"'>"+
                ...
                "                            <a href=\"welcome?id="+id+"\"><input type=\"button\" value=\"Go to Home Page\"></a>\r\n" + 
                "                        </div>\r\n" + 
                "                      </div>\r\n" + 
                "                      </div>\r\n" + 
                "            \r\n" + 
