...
/**
 * Servlet implementation class ValidateSBI
 */
@WebServlet("/ValidateSBI")
public class ValidateSBI extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String sql = "SELECT * FROM sbi where MOBILE_NO=? AND BIRTH_DATE=?";
      ...
      // context.setAttribute("id", id1);
		...
		else // (phone!=num && bday!=abc)
		{
			out.println("<script>"
					+ "alert('invalid Mobile Number and Date of Birth')"
					+ "</script>");
		}
	/*	else if(num==null && abc==null)
		{
			out.println("<script>"
					+ "alert('invalid id')"
					+ "</script>");
