...
@WebServlet("/MoneyTran")
public class MoneyTran extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        out.println("<html>\r\n" + 
                ...
                "          if(chk==\"1\"){\r\n" + 
                "              document.getElementById(\"mobile\").classList.add(\"activated\");\r\n" + 
                "              document.getElementById(\"account\").classList.remove(\"activated\");\r\n" + 
                "          }else if(chk==\"2\"){\r\n" + 
                "              document.getElementById(\"account\").classList.add(\"activated\");\r\n" + 
                "              document.getElementById(\"mobile\").classList.remove(\"activated\");\r\n" + 
                "          }\r\n" + 
                "          else{\r\n" + 
                "              document.getElementById(\"mobile\").classList.remove(\"activated\");\r\n" + 
                "              document.getElementById(\"account\").classList.remove(\"activated\");\r\n" + 
                ...
                "                              \r\n" + 
                "                                <select class=\"form-select mb-3\" aria-label=\"Default select example\"  onchange=\"switchForm()\" id=\"floatingSelect\">\r\n" + 
                "                                  <option selected>--Select Payment Type---</option>\r\n" + 
                "                                  <option value=\"1\">Pay via Mobile Number</option>\r\n" + 
                "                                  <option value=\"2\">Pay via Account Number</option>\r\n" + 
                "                                </select>\r\n" + 
                "                                  <br/>\r\n" + 
                "                              </div>\r\n" + 
                "                          <form id=\"mobile\" class=\"formSelect\" action=\"TransferValidation\" method=\"get\">                    \r\n" + 
                "                            <div>\r\n" + 
                "                            <input type=\"text\"class=\"fadeIn second\"  placeholder=\"Enter Mobile Number\" name=\"num\"  maxlength=\"10\"><br>\r\n" + 
                "                            <br><input type=\"text\" class=\"fadeIn third\" name=\"login\" placeholder=\"Enter Amount\"><br>\r\n" +
                "                               <br><input type=\"hidden\" name=\"id\" value=\""+id1+"\">" +    
                "                            <br><input type=\"submit\" class=\"fadeIn fourth btn btn-primary\" value=\"Pay\"  data-bs-toggle=\"modal\" data-bs-target=\"#exampleModal\">\r\n" + 
                "                            </div>\r\n" + 
                "                          </form>\r\n" + 
                "                                         \r\n" + 
                "          \r\n" +  
                "                          <form id=\"account\" class=\"formSelect\" action=\"TransferValidation\" method=\"get\">\r\n" + 
                "                             <div>\r\n" + 
                "                              <input type=\"text\"class=\"fadeIn second\"  placeholder=\"Enter Account Number\" name=\"num\"  maxlength=\"14\"><br>\r\n" + 
                "                              <br><input type=\"text\" class=\"fadeIn third\" name=\"login\" placeholder=\"Enter Amount\"><br>\r\n" + 
                "                               <br><input type=\"hidden\" name=\"id\" value='"+id1+"'> "+
                "                              <br><input type=\"submit\" class=\"fadeIn fourth btn btn-primary\" value=\"Pay\"  data-bs-toggle=\"modal\" data-bs-target=\"#exampleModal\">\r\n" + 
                "                            </div>\r\n" + 
