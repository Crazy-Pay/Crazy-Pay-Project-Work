...
/**
 * Servlet implementation class ValidateKotak
 */
@WebServlet("/ValidateKotak")
public class ValidateKotak extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String sql = "SELECT * FROM Kotak where MOBILE_NO=? AND BIRTH_DATE=?";
